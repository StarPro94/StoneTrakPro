...
interface AddBlockModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (block: Omit<Block, 'id' | 'userId' | 'createdAt' | 'updatedAt'>) => Promise<void>;
  materials: Material[];
}

export default function AddBlockModal({ isOpen, onClose, onAdd, materials }: AddBlockModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.material || !formData.length || !formData.width || !formData.height) {
